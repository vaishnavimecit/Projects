...
<tr><td style="width:150px;">User Id</td><td><input name="uid" type="text" id="uid" value="" required="required"  onsubmit="val_name(this.value)"></td></tr>
...
$a=$_POST['a'];
  ...
  echo '<script type="text/javascript">alert("Name Must be Letters"); </script>';
