...
<ul>
   ...
   <li ><a href='deposit.php'><span>Deposit</span></a></li>
    <li ><a href='fundtrans.php'><span>Fund Transfer</span></a></li>
     <li  class='active'><a href='balance.php'><span>Balance Enquiry</span></a></li>
...
<table width="94%" border="0" cellspacing="0" style="background-color:#0861b5; margin:0px auto; width:950px; color:rgb(255,255,255)" align="center">
  <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="color:#FFFFFF;">
    <form action="fundtrans.php" method="post" enctype="multipart/form-data" name="admindes"
    onsubmit="return validation()">
  <tr >
    <th colspan="3" scope="col" align="center">
    <img src="images/check.png" width="128" height="128" style="margin-left:30px;" /></th>
    </tr>
  ...
  <?php 
	...
	$sqsl ="SELECT * FROM deposit where username = '".$_SESSION['userid']."'";
	$my=mysql_query($sqsl);
  ...
  <tr>
    ...
    <th width="30%" scope="row"><?php echo $rowtr->dep_accno;  ?></th>
    <td width="44%" align="center"><?php echo $rowtr->dep_amt;  ?></td>
  </tr>
     </form>
    </table>
