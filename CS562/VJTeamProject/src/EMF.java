...
//this generator class is for generate emf query output file
...
public class EMF{
    static void generateCode(HashMap<String,String> db_struct, QueryStruct qs){
        ...
        output.print("/* CS 562 final project by Vaishnavi & Jenal */\n");
        
        //generate class dbTuple
        output.print("class db{\n");
        ...
        output.print("\tString pwd =\"24192Aboys@\";\n");
        output.print("\tString url =\"jdbc:postgresql://localhost:5432/VGopalakrishnan_F19\";\n");
