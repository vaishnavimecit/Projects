	...
	public static void main(String[] args) {
		...
		try {
            ...
            String s = in.nextLine();
          	...
          	//MF 
            if (s.equals("mf")){     
                    File file = new File("/C:/Users/vaish/Documents/Projects/CS562/VJTeamProject/src/sampleMF.txt");
            ...
            //EMF
                    ...
                    File file = new File("C:/Users/vaish/Documents/Projects/CS562/VJTeamProject/src/sampleEMF.txt");
                    QueryStruct query_struct = new QueryStruct(); 
                    //read from query and get info
                    query.query_process(query_struct, file);
                    //Query.output(query_struct);
