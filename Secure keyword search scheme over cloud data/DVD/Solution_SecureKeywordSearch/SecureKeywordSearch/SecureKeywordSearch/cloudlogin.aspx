<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="cloudlogin.aspx.cs" Inherits="Default2" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        ID="txt_pass" CssClass="texta1" runat="server" TextMode="Password" 
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" Height="36px" 
                    ImageUrl="~/images/yellow1.png" onclick="ImageButton1_Click" Width="85px" />
&nbsp;
                <asp:ImageButton ID="ImageButton2" runat="server" Height="36px" 
                    ImageUrl="~/images/yellow2.png" onclick="ImageButton2_Click" Width="94px" />
                <img src="images/cloudlog3.png" 
                    style="position:absolute; top: 300px; left: 754px; height: 265px; width: 460px;" /></td>
        </tr>
    </table>
</asp:Content>
