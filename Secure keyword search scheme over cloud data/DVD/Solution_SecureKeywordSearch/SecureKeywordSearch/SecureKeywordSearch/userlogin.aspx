<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="userlogin.aspx.cs" Inherits="Default2" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        ID="txt_pass" CssClass="texta1" runat="server" TextMode="Password" 
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" Height="36px" 
                    ImageUrl="~/images/gray1.png" onclick="ImageButton1_Click" Width="85px" />
&nbsp;
                <asp:ImageButton ID="ImageButton2" runat="server" Height="36px" 
                    ImageUrl="~/images/gray2.png" onclick="ImageButton2_Click" Width="94px" />
                <img src="images/user1.png" 
                    style="position:absolute; top: 301px; left: 829px; height: 227px; width: 281px;"/></td>
        </tr>
    </table>
</asp:Content>
