<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Guestlog.aspx.vb" Inherits="Guestlog" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Monotype Corsiva"
            Font-Size="XX-Large" Height="56px" Text="MY ASP.NET GUESTLOG" Width="400px"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <br />
        <br />
        <br />
            ...
            <table style="width: 608px; height: 376px">
                <tr>
                    ...
                    <td style="width: 100px; height: 64px">
                        <asp:TextBox ID="TextBox1" runat="server" Height="32px" Width="168px"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 100px; height: 63px">
                        <asp:TextBox ID="TextBox2" runat="server" Height="32px" Width="168px"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 100px; height: 73px">
                        <asp:TextBox ID="TextBox3" runat="server" Height="24px" Width="168px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 68px">
                    ...
                    <td style="width: 100px">
                        <br />
                        <br />
                        <asp:TextBox ID="TextBox4" runat="server" Height="80px" Width="240px"></asp:TextBox><br />
                    </td>
                </tr>
                <tr>
                    <td style="width: 68px">
                ...
                <tr>
                    <td style="width: 68px">
                        <asp:Button ID="Button1" runat="server" Height="40px" Text="BACK" Width="120px" /></td>
                    <td style="width: 100px">
                    </td>
                </tr>
                <tr>
